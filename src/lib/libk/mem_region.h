...
public:
  ...
  void del(unsigned start, unsigned end)
  {
  ...
  bool add(Mem_region const &r) override
  {
    if (!r.valid())
      return true;
  ...
  bool sub(Mem_region const &r) override
  {
    if (!r.valid())
      return true;
  ...
  Mem_region const &operator [] (unsigned idx) const
  {
    return _r[idx];
  }

  Mem_region &operator [] (unsigned idx)
  {
    return _r[idx];
  }
