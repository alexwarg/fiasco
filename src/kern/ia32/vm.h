...
protected:
   ...
   */
  static void load_guest_xcr0(Unsigned64 host_xcr0, Unsigned64 guest_xcr0)
  {
   ...
   */
  static void restore_host_xcr0(Unsigned64 host_xcr0, Unsigned64 guest_xcr0)
  {
  ...
  static bool is_64bit() { return sizeof(Mword) == 8; }
};
