...
static constexpr unsigned Num_irqs = 96;
#endif
#ifdef CONFIG_PF_OMAP3_AM33XX
static constexpr unsigned Num_irqs = 128;
#endif
...
public:
  ...
  Unsigned32 pending()
  {
    for (unsigned n = 0; n < (Num_irqs >> 5); ++n)
      {
