...
#define BOOTSTRAP_INIT_PRIO      DEPENDS_ON(ALT_INSN_INIT_PRIO)
...
#define PLATFORM_INIT_PRIO       DEPENDS_ON(STARTUP1_INIT_PRIO)
// at this stage spinlocks must be working
#define ROOT_FACTORY_INIT_PRIO   DEPENDS_ON(PLATFORM_INIT_PRIO)
