#pragma once
// ARM Proc_arch<DERIVED> — common ARM Proc members.
// Includes the bitness-specific header first, then adds ARM-common content.

#include "types.h"
#include "std_macros.h"
#include <globalconfig.h>
#include <cxx/bitfield>
#include <processor-arm-bits.h>

// ---------------------------------------------------------------------------
// Arm_esr — Exception Syndrome Register bitfield class
...
// ---------------------------------------------------------------------------
// Proc_arch<DERIVED>: ARM-common Proc members + inherits Proc_arm_bits<DERIVED>

template<typename DERIVED>
class Proc_arch : public Proc_arm_bits<DERIVED>
{
private:
  using B = Proc_arm_bits<DERIVED>;

public:
  using typename B::Status;
  ...
  enum : unsigned
  {
    ...
    Status_always_mask      = B::Status_mode_always_on,
  };
#else
  enum : unsigned
  {
    ...
    Status_always_mask      = B::Status_mode_always_on | Status_IRQ_disabled,
  };
#endif

#ifndef CONFIG_CPU_VIRT
  enum : unsigned { Is_hyp = 0, Status_mode_supervisor = PSR_m_svc };
#else
  enum : unsigned { Is_hyp = 1, Status_mode_supervisor = PSR_m_hyp };
#endif
