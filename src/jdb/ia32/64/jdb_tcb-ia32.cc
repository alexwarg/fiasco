...
Jdb_tcb::print_entry_frame_regs(Thread *t)
{
  ...
  printf("RAX=%016lx  RSI=%016lx\n"
	 ...
	 ef->_r12, ef->_r13, t->_cpu_state.gs_base,
         ef->_r14, ef->_r15, t->_cpu_state.fs_base,
  ...
  switch (state)
    ...
    case Jdb::s_ipc:
      printf("RAX=%016lx  RSI=%016lx\n"
	     ...
	     p.top_value(-15), p.top_value(-14), p.top_value(-1) & 0xffff, t->_cpu_state.gs_base,
	     p.top_value(-13), p.top_value(-12), p.top_value(-4) & 0xffff, t->_cpu_state.fs_base,
    ...
    case Jdb::s_user_invoke:
      printf("RAX=0000000000000000  RSI=0000000000000000\n"
	     ...
	     p.top_value(-2), p.top_value(-1) & 0xffff,
             t->_cpu_state.gs_base, t->_cpu_state.fs_base);
      break;
    case Jdb::s_fputrap:
