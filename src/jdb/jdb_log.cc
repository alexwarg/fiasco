...
public:
  ...
  void show_item(String_buffer *buffer, String_buffer *,
...
private:
  ...
  static unsigned patch_val(Tb_log_table_entry const *e)
...
public:
  ...
  bool invoke(Kobject_common *, Syscall_frame *f, Utcb *utcb) override
  {
